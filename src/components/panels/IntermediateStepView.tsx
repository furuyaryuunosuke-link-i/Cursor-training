import {
  getIntermediateStepById,
  getIntermediatePrevNext,
} from '../../data/intermediateSteps'
import { GlassCard } from '../GlassCard'
import { StepNavBar } from '../StepNavBar'

type IntermediateStepViewProps = {
  stepId: string
...
export function IntermediateStepView({
  stepId,
  onNavigateToStep,
}: IntermediateStepViewProps) {
  const resolved = getIntermediateStepById(stepId)
  const { prev, next } = getIntermediatePrevNext(stepId)

  if (!resolved) {
    return (
      <section
        id="panel-intermediate-step"
        role="tabpanel"
